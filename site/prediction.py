...
def capture_plate(video):
    ...
    while True:
        ...
        if confidence>= 85:
            fcount =fcount+1
        if fcount == 2:
            cv2.imwrite("C:/Users/Rishabh/Desktop/task ARTH/sm task-8/numberplate_web-main/site/static/styles/carcont.jpeg",frames)
            s = 1
        if s==1:
            ...
            if detected == 1:
                ...
                cv2.imwrite("C:/Users/Rishabh/Desktop/task ARTH/sm task-8/numberplate_web-main/site/static/styles/number.jpeg",Cropped)
...
def final():
        org, text , success =capture_plate('C:/Users/Rishabh/Desktop/task ARTH/sm task-8/numberplate_web-main/site/static/new.mp4')
        print(text)
